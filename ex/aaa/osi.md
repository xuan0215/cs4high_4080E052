...
區域網路用的協定:
[必考，狗才說超級重要]IEEE 802.3：乙太網路（Ethernet）
...
[必考，狗才說超級重要]IEEE 802.11：無線區域網路（Wireless LAN & Mesh）
...
[會考，狗才說重要]0  Echo Reply（回應答覆）
[會考，狗才說重要]3  Destination Unreachable（目的地無法到達）

4 Source Quench（來源抑制）

[會考，狗才說重要]5 Redirect（改變傳輸路徑）

[會考，狗才說重要]8 Echo Request（回應要求）
...
追蹤 www.google.com [172.217.24.4] 的路由:
  ...
  3    13 ms     9 ms     3 ms  120-114-151-14.ksu.edu.tw [120.114.151.14]
  4     *        *        *     要求等候逾時。
  5     *        *        *     要求等候逾時。
  6     *        *        *     要求等候逾時。
  7     *        *        *     要求等候逾時。
